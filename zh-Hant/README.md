...
在開啟太陽、月亮圖層時，日月光蒙版也隨之自動開啟。日光蒙版以四層恆定的亮度疊加，分別對應白晝、民用曙光、航海曙光和天文曙光的可見範圍。月光蒙版的亮度則隨月照亮度線性變化，滿月時最亮，虧相時接近不可見。月食發生時，月光蒙版會隨本影食分的大小而染上岩紅色。右上角的圖層選項提供了日月光蒙版的開關。
...
為給太陽等天體的位置提供參考，網站繪製了黃道、赤道、白道、銀道等座標參考線，可以在右上角的圖層選項中選擇開啟或關閉。作為太陽所在的參考線，黃道以雙線銅帶的風格繪製，銅帶中標註二十四節氣對應黃經，以及間隔 1° 的黃經刻度。滑鼠懸停在節氣標籤上時，可見下次節氣對應的具體時刻。開啟星官圖層，可見二十八宿圍繞在黃道周圍。
